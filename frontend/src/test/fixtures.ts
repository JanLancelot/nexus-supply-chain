...
export const products: Product[] = [
  { id: 'product-1', sku: 'SOAP-01', name: 'Hand Soap', unitPrice: 12.5, stockQuantity: 30,
    reorderLevel: 10, lowStockIndicator: false, categoryId: 'care', categoryName: 'Personal Care',
  ...
  { id: 'product-2', sku: 'PAPER-02', name: 'Paper Towels', unitPrice: 7.25, stockQuantity: 3,
    reorderLevel: 5, lowStockIndicator: true, categoryId: 'home', categoryName: 'Household',
    warehouseId: 'warehouse-1', warehouseName: 'Central Warehouse' },
];
...
export const suppliers = [
  { id: 'supplier-1', name: 'North Supply', active: true },
  { id: 'supplier-2', name: 'Retired Supplier', active: false },
];
...
export const metrics: DashboardMetrics = {
  ...
  warehouseStockCounts: { 'Central Warehouse': 400, 'East Warehouse': 150 },
