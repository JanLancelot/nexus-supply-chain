...
class RepositoryTests {
    ...
    void testUserRepository_findByEmailAndRole() {
        ...
        Optional<User> found = userRepository.findByEmail("repo@example.test");
        ...
        assertEquals("repo@example.test", usersByRole.get(0).getEmail());
    }
    ...
    void testProductRepository_CustomQueries() {
        ...
        assertEquals(warehouse.getId(), stockByWh.get(0)[0]);
