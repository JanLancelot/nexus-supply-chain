...
class SecurityConfigTest {
    ...
    @Test
    void referenceDataDeepLinkForwardsToTheApplicationShell() throws Exception {
        mvc.perform(get("/reference-data")).andExpect(status().isOk())
    ...
    @Configuration
    @EnableWebMvc
    @Import({SecurityConfig.class, com.nexus.supplychain.controller.FrontendController.class})
