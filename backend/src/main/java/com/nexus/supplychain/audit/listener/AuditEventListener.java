package com.nexus.supplychain.audit.listener;

import com.nexus.supplychain.kafkalite.KafkaLiteBroker;
import com.nexus.supplychain.kafkalite.event.AuditEvent;
...
public class AuditEventListener {
    ...
    public void registerListener() {
        broker.subscribe("audit-events", "legacy-audit", this::handleAuditEvent);
    ...
    private void handleAuditEvent(String messageJson) {
        try {
            ...
            throw new IllegalStateException("AuditEventListener: Failed to process AuditEvent message", e);
        }
    }
}
