...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
    ...
    java.util.Optional<Notification> findByUserAndSourceEventId(User user, UUID sourceEventId);
    ...
    int deleteOldReadNotifications(@Param("threshold") OffsetDateTime threshold);
}
