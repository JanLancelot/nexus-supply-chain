...
public class JacksonLiteRedisSerializer implements RedisSerializer<Object> {
    ...
    public JacksonLiteRedisSerializer(ObjectMapper objectMapper) {
        PolymorphicTypeValidator ptv = BasicPolymorphicTypeValidator.builder()
                ...
                .allowIfSubType(Pattern.compile("com\\.nexus\\.supplychain\\.dto\\.(ProductResponse|PagedResponse|CategoryResponse|WarehouseResponse|AnalyticsDashboardResponse(\\$(TopProduct|WarehouseStock))?)"))
