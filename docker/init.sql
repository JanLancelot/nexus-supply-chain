...
CREATE TABLE inventory_transactions (
    ...
    CONSTRAINT fk_transactions_warehouse FOREIGN KEY (warehouse_id) REFERENCES warehouses(id) ON DELETE RESTRICT,
    CONSTRAINT fk_transactions_user FOREIGN KEY (performed_by) REFERENCES users(id) ON DELETE SET NULL
);
...
CREATE TABLE supplier_products (
    ...
    CONSTRAINT fk_supplier_prod_supplier FOREIGN KEY (supplier_id) REFERENCES suppliers(id) ON DELETE CASCADE,
    CONSTRAINT fk_supplier_prod_product FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE CASCADE
);
